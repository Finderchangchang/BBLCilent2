package com.beibeilian.chat.widget;
...
public class MyEditText extends EditText implements
	...
	protected void onCreateContextMenu(ContextMenu menu) {
		// menu.add(0, ID_PASTE, 0, "Õ³Ìù").setOnMenuItemClickListener(this);
		// menu.add(0, ID_CUT, 1, "¼ôÇÐ").setOnMenuItemClickListener(this);
		// menu.add(0, ID_COPY, 1, "¸´ÖÆ").setOnMenuItemClickListener(this);
		// menu.add(0, ID_SELECT_ALL, 1, "È«Ñ¡").setOnMenuItemClickListener(this);
