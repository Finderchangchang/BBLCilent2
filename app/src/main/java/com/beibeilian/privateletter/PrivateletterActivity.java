...
import com.beibeilian.privateletter.adapter.PrivateletterAdapter;
...
public class PrivateletterActivity extends Activity implements OnLoadListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		privateletter_PullToRefreshLayout.setOnRefreshListener(new OnRefreshListener() {
			...
			public void run() {
				...
				try {
					...
					if (jsonObject.optInt("result") == BBLConstant.MEMBER_STATE_NUMBER_OUT) {
						...
						Intent intent = new Intent(PrivateletterActivity.this, MeMemberActivity.class);
						intent.putExtra("toUser", touser);
						intent.putExtra("toName", name);
						startActivity(intent);
	...
	private Handler handler = new Handler() {
		public void handleMessage(android.os.Message msg) {
			...
			case 3:
				...
				startActivity(new Intent(PrivateletterActivity.this, MeMemberActivity.class));
